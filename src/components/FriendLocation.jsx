                ...
                {props.index === props.currentKey && (
                    <ul className={Style.friendDetail}>
                        ...
                        <li>パスポート：{props.passportNumber}</li>
                            <li>最終共有時間：{(props.nowTime - props.lastShareTime) + "分前"}
                        </li>
                    </ul>
                )}
            </div>
                    ...
                    {props.index === props.currentKey && (
                        <div className={Style.friendDetail_nonShare}>
                            <ul>
                                ...
                                <li>国籍：{props.nationality}</li>
                                <li>パスポート：{props.passportNumber}</li>
                                <li>最終共有時間：{String(props.lastShareTime).slice(0, 4) + "年" + String(props.lastShareTime).slice(5, 6) + "月" + String(props.lastShareTime).slice(7, 8) + "日" + String(props.lastShareTime).slice(8, 10) + ":" + String(props.lastShareTime).slice(10, 12)}</li>
                            </ul>
